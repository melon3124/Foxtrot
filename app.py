...
if st.session_state["view"] == "summary":
    ...
    report_tabs = st.tabs(["🧠 Academic", "🏃‍♂️ PFT", "🎖️ Military", "📋 Conduct"])
    ...
    with report_tabs[0]:
        ...
        # Deficiencies per Subject
        st.markdown("#### 📌 Deficiencies per Class, per Subject")
        ...
        # Cadets with >2 Deficiencies
        st.markdown("#### 🚩 Cadets with More Than 2 Deficient Subjects")
        ...
        # Became Proficient
        st.markdown("#### 📈 Cadets Who Became Proficient")
        ...
        # Top Performers
        st.markdown("#### 🏆 Top Performing Cadets per Subject per Class")
        top_performers = melted.sort_values(by=["CLASS", "Subject", "Grade"], ascending=[True, True, False])
    ...
    # ---------- PFT Report ----------
    with report_tabs[1]:
        st.subheader("🏃‍♂️ PFT Summary Report")
        st.info("Coming soon...")

    # ---------- Military Report ----------
    with report_tabs[2]:
        st.subheader("🎖️ Military Summary Report")
        st.info("Coming soon...")

    # ---------- Conduct Report ----------
    with report_tabs[3]:
        st.subheader("📋 Conduct Summary Report")
        st.info("Coming soon...")
